...
public class main {
    public static void main(String[]args){
        ...
        AddSubject_Service add_sub = new AddSubject_Service();
        add_sub.add_subjects(MainStore,"English Grammar","Mathematics","Physics","Chemistry","Biology");


        AddTeacher_Service add_teacher = new AddTeacher_Service();
        add_teacher.add_Teachers(MainStore,"John Smith","Lara Gilbert","Johanna Kabir","Danniel Robertson","Larry Cooper");
